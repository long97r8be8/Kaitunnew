...
spawn(function() 
  wait(2400) 
  game.Players.LocalPlayer:Kick("Long X Hub") 
end )
...
TextLabel.Text = "Long X Hub One Click"
...
ImageLabel.Image = "rbxassetid://18871428100"
...
script_time = os.time()
if not isfolder(".LongX/BloxFruit/Kaitun/") then
...
Info:AddLabel("Long X Community Kaitun Script") 
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
           ...
           task.spawn(function()
            ...
            function noti(b, d)
               ...
               {
                  Description = b,
                  Title = "Long X Hub • notifications",
                  Duration = d or 5
               }
               )
            end
